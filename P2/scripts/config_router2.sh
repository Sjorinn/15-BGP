...
# This line is for the static part: Create vxlan on eth0 with only local and remote "members"
# ip link add name vxlan10 type vxlan id 10 dev eth0 remote 10.1.1.1 local 10.1.1.2 dstport 4789
# And this one is for dynamic: Create vxlan on eth0 with whole group as "members"
